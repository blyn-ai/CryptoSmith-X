...
/// <c>WebApp/Format.cs</c> — a missing value is always an em dash, never an invented number — with
...
public static class Format
{
    ...
    /// written with.
    ///
    /// <b>These three numbers are also in arena.css as --spark-w, --spark-h and --mirror-h, and the
