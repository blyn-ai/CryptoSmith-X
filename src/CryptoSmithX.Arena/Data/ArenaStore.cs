...
/// <c>WebApp/Data/PairStore.cs</c>, with three differences that are the point of the file.
///
...
/// <c>arena_reader</c> precisely so this stays a permission rather than a convention.
///
