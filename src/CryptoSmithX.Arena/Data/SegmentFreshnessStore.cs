...
/// admin console reads exactly that. 0025 does not grant it to <c>arena_reader</c>, deliberately:
    ...
    public const string Sql =
        ...
        with live as (
            select i.segment_code,
             ...
             -- The same population the pages publish, for the same reasons (see ArenaStore): an
