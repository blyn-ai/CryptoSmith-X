...
public static class StrategyParameterCatalog
{
    ...
    [
        Decimal("markets", "Trading", "MaxActiveInstruments", "Stebimų rinkų skaičius", "rinkos", 1m, 100m, 1m, 0,
            "Kiek aktyviausių rinkų botas vienu metu tikrina ieškodamas progų.",
            "Daugiau rinkų = daugiau galimų signalų, bet ir daugiau triukšmo.",
            "Mažiau rinkų", "Daugiau galimybių",
            "Botas neseka visos biržos. Jis renkasi aktyviausias rinkas ir tik jose ieško progų.",
            "Ramesnis srautas, mažiau atsitiktinių signalų.",
            "Daugiau progų, bet ir daugiau triukšmo.",
            "Sąrašas perrenkamas kas ciklą pagal 24 val. apyvartą; iškritusiose rinkose naujos pozicijos nebeatidaromos, jau atviros tvarkomos iki galo."),
        Decimal("volume", "Trading", "StrongMoverMinDailyVolumeEur", "Minimali 24 val. apyvarta", "USD", 1_000m, 100_000_000m, 1_000m, 0,
            "Per ramias ir mažai prekiaujamas rinkas botas praleidžia.",
            "Didesnis minimumas palieka tik aktyviau prekiaujamas rinkas.",
            "Daugiau rinkų", "Likvidesnės rinkos",
            "Filtras, kuris išmeta rinkas, kuriose beveik nevyksta prekyba.",
            "Į atranką patenka daugiau, bet ramesnių rinkų.",
            "Lieka tik likvidžios rinkos, kuriose lengviau įeiti ir išeiti.",
            "Apyvarta imama iš rinkos duomenų agregato; rinkos be pakankamos momentų istorijos atmetamos atskira sąlyga."),
        ...
        Decimal("stop", "Exits", "StopAtrMult", "Stop loss", "× ATR", 0.50m, 3m, 0.05m, 2,
            ...
            "Stop loss atstumas matuojamas ATR — vidutiniu tos rinkos svyravimu. Ramioje rinkoje stop arčiau, neramioje — toliau.",
        ...
        Decimal("cooldown", "ExecutionPolicy", "CooldownAfterStopLossSeconds", "Pauzė po stop loss", "min.", 0m, 480m, 15m, 0,
            ...
            "Po nuostolingo sandorio toje pačioje rinkoje botas trumpam sustoja.",
            "Botas grįžta greičiau — daugiau bandymų.",
            "Ilgesnė pauzė — mažiau pakartotinių klaidų toje pačioje situacijoje.",
            "Pauzė galioja tam pačiam instrumentui; kitos rinkos prekiaujamos toliau.",
