...
/// so <c>/studio/Pairs/Pair?baseFamily=…</c> and <c>/studio/Pairs/Live?baseFamily=…</c> reach the same
...
/// as they are — they still keep the two-segment route from claiming <c>/studio/ds/styles.css</c>,
...
public static partial class PairAddress
{
    ...
    /// <c>/studio/BTC%0A/USD</c> cleared the route constraint and the action guard, ran the whole
