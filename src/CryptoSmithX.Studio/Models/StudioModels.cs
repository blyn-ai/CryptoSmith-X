    ...
    DateTime? DepthAt)
{
    ...
    /// things. It carries no verdict either way; see <see cref="CryptoSmithX.Studio.Data.Verdicts"/>.
    /// </summary>
...
/// to carry a clock. <see cref="CryptoSmithX.Studio.Data.Verdicts.Compute"/> is called per request,
