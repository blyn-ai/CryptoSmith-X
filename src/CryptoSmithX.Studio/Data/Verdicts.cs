...
/// JavaScript: see the withdrawal block in <c>wwwroot/studio-ages.js</c>, which argues the three
...
public static class Verdicts
{
    ...
    ///
    /// It exists for the client. <c>studio-ages.js</c> cannot recompute a rank and must not try, so
