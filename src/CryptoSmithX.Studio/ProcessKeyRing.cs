...
/// every deployment — writes a key there, and warns that the key is unencrypted at rest. Studio
...
///
/// If a later step gives Studio a form, this class is what to revisit: an antiforgery token protected
