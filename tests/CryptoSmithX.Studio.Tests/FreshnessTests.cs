...
/// in the WebApp.Admin exists because a literal 30 s made Kraken read degraded at 39 s — and the public
...
public sealed class FreshnessTests
{
    ...
    public void The_client_picks_the_two_ends_the_same_way_and_says_the_same_words()
    {
        ...
        // studio-ages.js every second after it — so the fix had to land in both or the labels would
        ...
        var script = File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "surface", "studio-ages.js"));
