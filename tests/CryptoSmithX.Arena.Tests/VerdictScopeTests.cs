...
public sealed class VerdictScopeTests
{
    ...
    // claim was made across and one verb, retract. See the argument in arena-ages.js.
    ...
    public void The_view_hands_the_client_the_grouping_and_the_client_uses_that_one()
    {
        ...
        Assert.Contains("data-rank", Read("arena-ages.js"), StringComparison.Ordinal);
    }
