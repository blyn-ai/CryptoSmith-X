...
public sealed class StatementTests
{
    ...
    // push, and in arena-ages.js, which re-derives it every second from the same data-at / data-win
    ...
    public void The_client_says_the_same_words_the_server_does(string sentence) =>
        Assert.Contains(sentence, Read("arena-ages.js"), StringComparison.Ordinal);
    ...
    public void The_client_is_wired_to_the_element_the_view_marks()
    {
        ...
        Assert.Contains("data-statement-verdict", Read("arena-ages.js"), StringComparison.Ordinal);
    }
